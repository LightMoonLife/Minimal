...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-card border border-border/10 bg-panel/50 transition-all duration-320 ease-smooth',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'font-display text-lg font-extrabold text-foreground leading-snug tracking-tight',
      className
    )}
    {...props}
  />
