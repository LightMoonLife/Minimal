...
export const experience: Role[] = [
  {
    ...
    highlights: [
      'Transformed customer onboarding — 75% faster (4 weeks → 1 week), 62% cheaper (£512 → £196/customer)',
      'Engineered B2B portal (Laravel 10, Tailwind) — online orders +23%, consumables +17%, 0→67% customers ordering online in 18 months',
      'Launched sales tool \'IQ\' (multiple API integrations) — quote creation 20min → 4min (80% reduction)',
      'Drove HubSpot adoption across sales & marketing — full-stack automation & integration',
      'Accelerated conversion with CRO programme — 1.72% → 4.29% — +£90K/month revenue',
    ],
  },
  {
    ...
    highlights: [
      'Scaled marketing team 1→10; catapulted digital revenue £600K→£2.2M on <2% budget',
      'Forced 7% market share in Design & Build sector in 2 years',
      'Optimised social engagement 1.2%→7%; traffic +2,300%',
      'Built highest-performing team — engagement score 7.2→9.6 (company-wide lead)',
  ...
  },
  {
    ...
    highlights: [
      'Dominated #1 ranking for top industry keyword — traffic 720→13,320/month',
      'Optimised landing page CRO — conversion 1.24%→4.21%',
      '0→30+ customers/month from one page — £300K in 6 months (1 day/week)',
    ],
  },
  {
    ...
    highlights: [
      ...
      'Designed Café Bonte Single Origins coffee packaging line',
    ],
  },
  {
    ...
    highlights: [
      ...
      'Grew organic traffic 0→15,000/month (self-taught SEO)',
      'Managed £7K/month PPC — CPA £90 vs £5,500 customer value (61:1 ROAS)',
      '50+ A/B tests — product page conversion 0.9%→3.1%',
  ...
  },
  {
    ...
    highlights: [
      ...
      'Optimised Disney/Nickelodeon approval process — production 3 months → 4 weeks',
