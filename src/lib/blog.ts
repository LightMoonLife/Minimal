...
export const posts: BlogPost[] = [
  {
    ...
    sections: [
      {
        heading: 'The 1.7% conversion rate is normal. That\'s the problem.',
        content: [
      ...
      },
      {
        ...
        content: [
          ...
          'When your page doesn\'t answer those questions immediately, they bounce. Not because your site is ugly, but because it\'s not structured around their decision.',
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'Approval routing was the other bottleneck. Standard orders sat in a manager\'s inbox for an average of 6 days waiting for sign-off. Not because they needed careful review, but because they were buried in a queue of other things.',
        ],
      },
      {
      ...
      },
      {
        ...
        content: [
          ...
          'The cost-per-customer metric (£512 to £196) was the number that got board attention and budget approval for the next phase of digital transformation work. If you want to fund further improvements, always frame the first win in terms the board speaks.',
        ],
      },
    ],
    faq: [
  ...
  },
  {
    ...
    readingTime: 5,
    tldr: 'B2B businesses outsource marketing because it feels lower-risk than building internal capability. But agencies have structural incentives that conflict with your commercial outcomes: they report on activity, not revenue; they optimise for their retainer, not your ROI; and they never build your internal capability because their business model depends on you staying dependent. I scaled a B2B equipment supplier\'s digital revenue from £600K to £2.2M by building an internal team of 10 on less than 2% of company revenue. Every system, process, and relationship stayed in the business when I moved on.',
    sections: [
      {
      ...
      },
      {
        ...
        content: [
          ...
          'First: deep integration with your operations. The agency doesn\'t know that your best customers come from the Design & Build sector, that your average deal takes 6 weeks to close, or that consumables have a 3x higher margin than equipment. Your revenue system needs to be built on that knowledge.',
      ...
      },
      {
        ...
        content: [
          'When I joined a B2B coffee equipment supplier as their first digital hire, digital revenue was £600K with no team, no strategy, and no systems. Over four years, I built an internal revenue system that produced £2.2M, a 3.7x increase on less than 2% of company revenue as budget.',
      ...
      },
      {
        ...
        content: [
          ...
          'But your core revenue system (the thing that generates leads, converts them to customers, and measures the connection between marketing spend and commercial outcome) has to live inside your business. Outsourcing it is outsourcing your understanding of how your own growth works.',
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          'If I\'d only done SEO: 13,320 visitors x 1.24% conversion = 165 leads/month. If I\'d only done CRO on the original 720 visitors: 720 x 4.21% = 30 leads/month.',
          'By doing both: 13,320 x 4.21% = 560 leads/month. The compound effect is not additive. It\'s multiplicative. Traffic x conversion x lead quality. Optimise all three and the results are nonlinear.',
